<?php
define('_MARION_VERSION_','1.1.0'); //versione di Marion
...
define('_MARION_UPLOAD_DIR_',_MARION_ROOT_DIR_."upload/"); //cartella in cui vengono caricate le immagini e gli allegati
...
define('_MARION_COMPRESSED_DIR_',_MARION_ROOT_DIR_."minimized/"); //comprime i files css in un unico file
