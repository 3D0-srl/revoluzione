...
class AmazonTool{
	...
	public function getMarketplaceLang($state){
	...
	public function getMarketplaceId($state){
		return self::$markets[$state];
	}

	public function getMarketplaceCurrency($state){
		return self::$currency_markets[$state];
	}

	public function getMarketplaceImage($state){
		return "images/".self::$img_markets[$state];
	}

	public function getEndpoint($state){
		switch($state){
			case 'Canada':
			case 'US':
			case 'Mexico':
