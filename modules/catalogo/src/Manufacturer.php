...
class Manufacturer extends Base{
	...
	// COSTANTI DI BASE
	const TABLE = 'manufacturer'; // nome della tabella a cui si riferisce la classe
	const TABLE_PRIMARY_KEY = 'id'; //chiave primaria della tabella a cui si riferisce la classe
	const TABLE_LOCALE_DATA = 'manufacturerLocale'; // nome della tabella del database che contiene i dati locali
	const TABLE_EXTERNAL_KEY = 'manufacturer';// / nome della chiave esterna alla tabella del database
	...
	function afterSave(){
		...
		$database = Marion::getDB();
		$list = $database->select('id','product',"parent=0 AND deleted = 0 AND manufacturer = {$this->id}");
