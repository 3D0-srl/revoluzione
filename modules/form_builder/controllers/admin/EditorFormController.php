...
class EditorFormController extends ModuleController{
	public $_auth = 'cms';
	...
	function setMedia(){
			...
			$this->registerCSS(_MARION_BASE_URL_.'plugins/codemirror/addon/display/fullscreen.css');
			$this->registerCSS(_MARION_BASE_URL_.'plugins/codemirror/theme/night.css');
			...
			$this->registerJS(_MARION_BASE_URL_.'plugins/codemirror/mode/htmlembedded/htmlembedded.js','head');
			$this->registerJS(_MARION_BASE_URL_.'plugins/codemirror/addon/mode/multiplex.js','head');
			$this->registerJS(_MARION_BASE_URL_.'plugins/codemirror/addon/selection/active-line.js','head');
			$this->registerJS(_MARION_BASE_URL_.'plugins/codemirror/addon/selection/matchbrackets.js','head');
			$this->registerJS(_MARION_BASE_URL_.'plugins/codemirror/addon/display/fullscreen.js','head');
	...
	function display(){
		...
		$_data = $database->select('*','composition_page_tmp',"id={$id_box}");
		...
		if( $this->isSubmitted()){
			switch($tab){
				...
				case 'generale':
					...
					$dati['action_submit'] = $array['action_submit'];
			...
			$database->update('composition_page_tmp',"id={$id_box}",array('parameters'=>$toupdate));
		}
		

		
		$dataform_general = $this->getDataForm('form_builder_general',$dati);
		$dataform_email = $this->getDataForm('form_builder_email',$dati_email);
