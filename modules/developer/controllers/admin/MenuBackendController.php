...
class MenuBackendController extends AdminModuleController{
    ...
    function ajax(){
        ...
        switch($action){
            case 'save_order':
                ...
                $database->update('menuItem',"scope = 'frontend'",$update);
    ...
    function setMedia(){
		if( $this->getAction() == 'list'){
			...
			$this->registerJS('../modules/developer/js/menu_backend.js?v=3','end');
		}else{
    ...
    function displayList(){
        ...
        $menu = MenuItem::prepareQuery()->where('scope','frontend')->get();
