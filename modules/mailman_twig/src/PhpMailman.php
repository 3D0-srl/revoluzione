...
class PhpMailman
{
	...
	public function api($action="") {
		...
		// cURL
		//$action="http://addati.it/mailman/admin/newsletter_addati.it/mailman/admin/Newsletter/members/add?subscribe_or_invite=0&send_welcome_msg_to_this_batch=1&send_unsub_notifications_to_list_owner=1&subscribees_upload=ciro@3d0.it&adminpw=Amedeo87";
	 ...
	 * Set notify user
	 */
	public function set_notifyuser($notifyuser='0') { // 0 | 1
	...
	private function prepare_url($url='', $email='') {
		...
		$url = str_replace($tags, $replacements, $url);
